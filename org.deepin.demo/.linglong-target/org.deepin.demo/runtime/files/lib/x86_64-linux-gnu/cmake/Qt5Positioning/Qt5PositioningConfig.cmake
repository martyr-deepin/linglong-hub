...
macro(_populate_Positioning_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Positioning_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Positioning)
    ...
    set(_Qt5Positioning_OWN_INCLUDE_DIRS "${_qt5Positioning_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Positioning_install_prefix}/include/x86_64-linux-gnu/qt5/QtPositioning")
    set(Qt5Positioning_PRIVATE_INCLUDE_DIRS
        "${_qt5Positioning_install_prefix}/include/x86_64-linux-gnu/qt5/QtPositioning/5.15.7"
        "${_qt5Positioning_install_prefix}/include/x86_64-linux-gnu/qt5/QtPositioning/5.15.7/QtPositioning"
    )
    ...
    macro(_populate_Positioning_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Positioning_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Positioning_check_file_exists(${imported_location})
