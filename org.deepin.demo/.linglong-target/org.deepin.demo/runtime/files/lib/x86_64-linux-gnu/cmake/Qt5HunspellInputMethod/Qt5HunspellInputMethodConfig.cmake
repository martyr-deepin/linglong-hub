...
set(Qt5HunspellInputMethod_VERSION_STRING 5.15.7)
...
macro(_populate_HunspellInputMethod_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5HunspellInputMethod_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::HunspellInputMethod PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5HunspellInputMethod.so.5"
...
if (NOT TARGET Qt5::HunspellInputMethod)
    ...
    set(_Qt5HunspellInputMethod_OWN_INCLUDE_DIRS "${_qt5HunspellInputMethod_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5HunspellInputMethod_install_prefix}/include/x86_64-linux-gnu/qt5/QtHunspellInputMethod")
    set(Qt5HunspellInputMethod_PRIVATE_INCLUDE_DIRS
        "${_qt5HunspellInputMethod_install_prefix}/include/x86_64-linux-gnu/qt5/QtHunspellInputMethod/5.15.7"
        "${_qt5HunspellInputMethod_install_prefix}/include/x86_64-linux-gnu/qt5/QtHunspellInputMethod/5.15.7/QtHunspellInputMethod"
    )
    ...
    foreach(_module_dep ${_Qt5HunspellInputMethod_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.7 ${_Qt5HunspellInputMethod_FIND_VERSION_EXACT}
    ...
    if(TARGET Qt5::HunspellInputMethod)
        return()
    endif()
    ...
    set_property(TARGET Qt5::HunspellInputMethod
    ...
    set_property(TARGET Qt5::HunspellInputMethod PROPERTY INTERFACE_QT_PLUGIN_TYPES "")
    ...
    if (_Qt5HunspellInputMethod_PRIVATE_DIRS_EXIST)
        ...
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::HunspellInputMethodPrivate)
            ...
            set_target_properties(Qt::HunspellInputMethodPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::HunspellInputMethodPrivate"
            )
        endif()
    endif()

    _populate_HunspellInputMethod_target_properties(RELEASE "libQt5HunspellInputMethod.so.5.15.7" "" FALSE)
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::HunspellInputMethod AND NOT TARGET Qt::HunspellInputMethod)
    add_library(Qt::HunspellInputMethod INTERFACE IMPORTED)
    set_target_properties(Qt::HunspellInputMethod PROPERTIES
        INTERFACE_LINK_LIBRARIES "Qt5::HunspellInputMethod"
    )
endif()
