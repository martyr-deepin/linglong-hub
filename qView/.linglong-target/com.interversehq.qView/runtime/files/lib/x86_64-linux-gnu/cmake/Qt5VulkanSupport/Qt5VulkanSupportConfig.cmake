...
function(_qt5_VulkanSupport_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt5VulkanSupport_install_prefix}/lib/x86_64-linux-gnu/")
...
macro(_populate_VulkanSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5VulkanSupport_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::VulkanSupport)
    ...
    set(_Qt5VulkanSupport_OWN_INCLUDE_DIRS "${_qt5VulkanSupport_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5VulkanSupport_install_prefix}/include/x86_64-linux-gnu/qt5/QtVulkanSupport")
    set(Qt5VulkanSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5VulkanSupport_install_prefix}/include/x86_64-linux-gnu/qt5/QtVulkanSupport/5.15.7"
        "${_qt5VulkanSupport_install_prefix}/include/x86_64-linux-gnu/qt5/QtVulkanSupport/5.15.7/QtVulkanSupport"
    )
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_VulkanSupport_process_prl_file(
            "${_qt5VulkanSupport_install_prefix}/lib/x86_64-linux-gnu/libQt5VulkanSupport.prl" RELEASE
