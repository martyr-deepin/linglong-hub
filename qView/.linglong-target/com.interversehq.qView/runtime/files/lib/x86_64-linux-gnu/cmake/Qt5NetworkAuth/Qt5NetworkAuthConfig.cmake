...
macro(_populate_NetworkAuth_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5NetworkAuth_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(_Qt5NetworkAuth_OWN_INCLUDE_DIRS "${_qt5NetworkAuth_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5NetworkAuth_install_prefix}/include/x86_64-linux-gnu/qt5/QtNetworkAuth")
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/x86_64-linux-gnu/qt5/QtNetworkAuth/5.15.7"
        "${_qt5NetworkAuth_install_prefix}/include/x86_64-linux-gnu/qt5/QtNetworkAuth/5.15.7/QtNetworkAuth"
    )
    ...
    macro(_populate_NetworkAuth_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5NetworkAuth_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_NetworkAuth_check_file_exists(${imported_location})
