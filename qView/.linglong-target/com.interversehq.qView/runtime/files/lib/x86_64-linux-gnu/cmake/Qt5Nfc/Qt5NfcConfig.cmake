...
macro(_populate_Nfc_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Nfc_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Nfc)
    ...
    set(_Qt5Nfc_OWN_INCLUDE_DIRS "${_qt5Nfc_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Nfc_install_prefix}/include/x86_64-linux-gnu/qt5/QtNfc")
    set(Qt5Nfc_PRIVATE_INCLUDE_DIRS
        "${_qt5Nfc_install_prefix}/include/x86_64-linux-gnu/qt5/QtNfc/5.15.7"
        "${_qt5Nfc_install_prefix}/include/x86_64-linux-gnu/qt5/QtNfc/5.15.7/QtNfc"
    )
    ...
    macro(_populate_Nfc_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Nfc_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Nfc_check_file_exists(${imported_location})
