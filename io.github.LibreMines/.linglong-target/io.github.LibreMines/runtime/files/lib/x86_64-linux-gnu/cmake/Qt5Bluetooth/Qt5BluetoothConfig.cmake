...
macro(_populate_Bluetooth_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Bluetooth_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(_Qt5Bluetooth_OWN_INCLUDE_DIRS "${_qt5Bluetooth_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Bluetooth_install_prefix}/include/x86_64-linux-gnu/qt5/QtBluetooth")
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/x86_64-linux-gnu/qt5/QtBluetooth/5.15.7"
        "${_qt5Bluetooth_install_prefix}/include/x86_64-linux-gnu/qt5/QtBluetooth/5.15.7/QtBluetooth"
    )
    ...
    macro(_populate_Bluetooth_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Bluetooth_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Bluetooth_check_file_exists(${imported_location})
