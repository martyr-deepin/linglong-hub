...
macro(_populate_WebChannel_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5WebChannel_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(_Qt5WebChannel_OWN_INCLUDE_DIRS "${_qt5WebChannel_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5WebChannel_install_prefix}/include/x86_64-linux-gnu/qt5/QtWebChannel")
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/x86_64-linux-gnu/qt5/QtWebChannel/5.15.7"
        "${_qt5WebChannel_install_prefix}/include/x86_64-linux-gnu/qt5/QtWebChannel/5.15.7/QtWebChannel"
    )
    ...
    macro(_populate_WebChannel_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5WebChannel_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebChannel_check_file_exists(${imported_location})
