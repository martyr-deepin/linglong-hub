...
macro(_populate_3DRender_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt53DRender_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::3DRender)
    ...
    set(_Qt53DRender_OWN_INCLUDE_DIRS "${_qt53DRender_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt53DRender_install_prefix}/include/x86_64-linux-gnu/qt5/Qt3DRender")
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/include/x86_64-linux-gnu/qt5/Qt3DRender/5.15.7"
        "${_qt53DRender_install_prefix}/include/x86_64-linux-gnu/qt5/Qt3DRender/5.15.7/Qt3DRender"
    )
    ...
    macro(_populate_3DRender_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DRender_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_3DRender_check_file_exists(${imported_location})
