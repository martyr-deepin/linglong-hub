...
macro(_populate_Sensors_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Sensors_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Sensors)
    ...
    set(_Qt5Sensors_OWN_INCLUDE_DIRS "${_qt5Sensors_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Sensors_install_prefix}/include/x86_64-linux-gnu/qt5/QtSensors")
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/x86_64-linux-gnu/qt5/QtSensors/5.15.7"
        "${_qt5Sensors_install_prefix}/include/x86_64-linux-gnu/qt5/QtSensors/5.15.7/QtSensors"
    )
    ...
    macro(_populate_Sensors_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Sensors_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Sensors_check_file_exists(${imported_location})
