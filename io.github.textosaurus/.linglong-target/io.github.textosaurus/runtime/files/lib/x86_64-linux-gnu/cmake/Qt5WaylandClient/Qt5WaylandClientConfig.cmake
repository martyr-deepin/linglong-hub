...
macro(_populate_WaylandClient_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5WaylandClient_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::WaylandClient)
    ...
    set(_Qt5WaylandClient_OWN_INCLUDE_DIRS "${_qt5WaylandClient_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5WaylandClient_install_prefix}/include/x86_64-linux-gnu/qt5/QtWaylandClient")
    set(Qt5WaylandClient_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandClient_install_prefix}/include/x86_64-linux-gnu/qt5/QtWaylandClient/5.15.7"
        "${_qt5WaylandClient_install_prefix}/include/x86_64-linux-gnu/qt5/QtWaylandClient/5.15.7/QtWaylandClient"
    )
    ...
    macro(_populate_WaylandClient_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5WaylandClient_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WaylandClient_check_file_exists(${imported_location})
