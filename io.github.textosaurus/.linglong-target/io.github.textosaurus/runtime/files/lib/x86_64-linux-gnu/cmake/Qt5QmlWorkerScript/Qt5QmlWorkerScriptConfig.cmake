...
macro(_populate_QmlWorkerScript_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QmlWorkerScript_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(_Qt5QmlWorkerScript_OWN_INCLUDE_DIRS "${_qt5QmlWorkerScript_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5QmlWorkerScript_install_prefix}/include/x86_64-linux-gnu/qt5/QtQmlWorkerScript")
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/x86_64-linux-gnu/qt5/QtQmlWorkerScript/5.15.7"
        "${_qt5QmlWorkerScript_install_prefix}/include/x86_64-linux-gnu/qt5/QtQmlWorkerScript/5.15.7/QtQmlWorkerScript"
    )
    ...
    macro(_populate_QmlWorkerScript_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QmlWorkerScript_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QmlWorkerScript_check_file_exists(${imported_location})
