...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/x86_64-linux-gnu/qt5/QtMultimedia/5.15.7"
        "${_qt5Multimedia_install_prefix}/include/x86_64-linux-gnu/qt5/QtMultimedia/5.15.7/QtMultimedia"
    )
    ...
    set_property(TARGET Qt5::Multimedia
                 ...
                 directshow;evr;gpu_vivante;gstreamer_0_10;gstreamer_photography;resourcepolicy;wasapi;wmf;wmsdk;wshellitem)
