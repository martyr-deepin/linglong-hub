...
macro(_populate_TextToSpeech_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5TextToSpeech_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    set(_Qt5TextToSpeech_OWN_INCLUDE_DIRS "${_qt5TextToSpeech_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5TextToSpeech_install_prefix}/include/x86_64-linux-gnu/qt5/QtTextToSpeech")
    set(Qt5TextToSpeech_PRIVATE_INCLUDE_DIRS
        "${_qt5TextToSpeech_install_prefix}/include/x86_64-linux-gnu/qt5/QtTextToSpeech/5.15.7"
        "${_qt5TextToSpeech_install_prefix}/include/x86_64-linux-gnu/qt5/QtTextToSpeech/5.15.7/QtTextToSpeech"
    )
    ...
    macro(_populate_TextToSpeech_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5TextToSpeech_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_TextToSpeech_check_file_exists(${imported_location})
