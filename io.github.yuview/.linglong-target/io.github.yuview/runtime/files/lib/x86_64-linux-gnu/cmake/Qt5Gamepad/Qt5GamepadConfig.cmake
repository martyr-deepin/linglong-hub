...
macro(_populate_Gamepad_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Gamepad_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Gamepad)
    ...
    set(_Qt5Gamepad_OWN_INCLUDE_DIRS "${_qt5Gamepad_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Gamepad_install_prefix}/include/x86_64-linux-gnu/qt5/QtGamepad")
    set(Qt5Gamepad_PRIVATE_INCLUDE_DIRS
        "${_qt5Gamepad_install_prefix}/include/x86_64-linux-gnu/qt5/QtGamepad/5.15.7"
        "${_qt5Gamepad_install_prefix}/include/x86_64-linux-gnu/qt5/QtGamepad/5.15.7/QtGamepad"
    )
    ...
    macro(_populate_Gamepad_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Gamepad_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Gamepad_check_file_exists(${imported_location})
