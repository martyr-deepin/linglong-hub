...
macro(_populate_VirtualKeyboard_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5VirtualKeyboard_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(_Qt5VirtualKeyboard_OWN_INCLUDE_DIRS "${_qt5VirtualKeyboard_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5VirtualKeyboard_install_prefix}/include/x86_64-linux-gnu/qt5/QtVirtualKeyboard")
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/x86_64-linux-gnu/qt5/QtVirtualKeyboard/5.15.7"
        "${_qt5VirtualKeyboard_install_prefix}/include/x86_64-linux-gnu/qt5/QtVirtualKeyboard/5.15.7/QtVirtualKeyboard"
    )
    ...
    macro(_populate_VirtualKeyboard_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5VirtualKeyboard_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_VirtualKeyboard_check_file_exists(${imported_location})
